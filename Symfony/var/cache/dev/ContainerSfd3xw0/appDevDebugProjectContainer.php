...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'white_october.swiftmailer_db.spool' => __DIR__.'/getWhiteOctober_SwiftmailerDb_SpoolService.php',
        );
        $this->privates = array(
            ...
            'swiftmailer.mailer.default.spool.db' => true,
            'swiftmailer.plugin.messagelogger' => true,
            'swiftmailer.spool' => true,
            'swiftmailer.spool.db' => true,
            ...
            'white_october.swiftmailer_db.spool' => true,
        );
        $this->aliases = array(
            ...
            'swiftmailer.mailer.default.spool' => 'white_october.swiftmailer_db.spool',
            'swiftmailer.mailer.default.spool.db' => 'white_october.swiftmailer_db.spool',
            'swiftmailer.plugin.messagelogger' => 'swiftmailer.mailer.default.plugin.messagelogger',
            'swiftmailer.spool' => 'white_october.swiftmailer_db.spool',
            'swiftmailer.spool.db' => 'white_october.swiftmailer_db.spool',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iM7pNtIbK2', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Iui4zcNPjU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tJa1P9p92V', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u7giQgTch9', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yeLmr1srQx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    private $loadedDynamicParameters = array(
        ...
        'swiftmailer.spool.default.db.path' => false,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WhiteOctoberSwiftMailerDBBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/whiteoctober/swiftmailerdbbundle/WhiteOctober/SwiftMailerDBBundle'),
            ...
            case 'swiftmailer.spool.default.db.path': $value = ($this->targetDirs[0].'/swiftmailer/spool/default'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WhiteOctoberSwiftMailerDBBundle' => 'WhiteOctober\\SwiftMailerDBBundle\\WhiteOctoberSwiftMailerDBBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'symfony_example',
            'database_user' => 'postgres',
            'database_password' => 'gitgit12',
            ...
            'swiftmailer.mailer.default.single_address' => 'stedi2@o2.pl',
            ...
            'swiftmailer.single_address' => 'stedi2@o2.pl',
            ...
            'white_october.swiftmailer_db.spool.entity_class' => 'AppBundle\\Entity\\Email',
            'white_october.swiftmailer_db.spool.keep_sent_messages' => true,
            'white_october.swiftmailer_db.spool.class' => 'WhiteOctober\\SwiftMailerDBBundle\\Spool\\DatabaseSpool',
